# Algorithm & Data Structure Glossary
...
**Time Complexity**: The computational complexity that measures the amount of time an algorithm takes to complete as a function of the length of the input.
