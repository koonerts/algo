...
class MyStackQueue:
    """
    Implement a first in first out (FIFO) queue using only two collections. The implemented queue should support all the functions of a normal queue (push, peek, pop, and empty).
